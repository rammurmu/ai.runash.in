export default function AboutPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-extrabold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">About RunAsh AI</h1>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center bg-white dark:bg-gray-900 rounded-xl shadow p-6">
            <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Team member" className="w-20 h-20 rounded-full mb-3 border-4 border-blue-500" />
            <div className="font-semibold text-lg">Ash R.</div>
            <div className="text-sm text-gray-500">Founder & AI Engineer</div>
          </div>
          <div className="flex flex-col items-center bg-white dark:bg-gray-900 rounded-xl shadow p-6">
            <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Team member" className="w-20 h-20 rounded-full mb-3 border-4 border-purple-500" />
            <div className="font-semibold text-lg">Samira K.</div>
            <div className="text-sm text-gray-500">Product Designer</div>
          </div>
          <div className="flex flex-col items-center bg-white dark:bg-gray-900 rounded-xl shadow p-6">
            <img src="https://randomuser.me/api/portraits/men/65.jpg" alt="Team member" className="w-20 h-20 rounded-full mb-3 border-4 border-green-500" />
