...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-lg mx-auto mt-20 bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg">
      <h1 className="text-3xl font-bold mb-4 text-center bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Settings</h1>
        ...
        <div className="flex gap-4 mt-6">
          <Popover>
            <PopoverTrigger asChild>
              <button type="button" className="px-4 py-2 rounded bg-gradient-to-r from-gray-800 to-gray-600 text-white font-semibold shadow hover:from-gray-900 hover:to-gray-700 transition">
                What is theme?
              </button>
            </PopoverTrigger>
            <PopoverContent className="text-sm max-w-xs">
              ...
              <ul className="list-disc pl-4 text-left text-gray-700 dark:text-gray-300">
                <li><b>System</b>: Follows your device's theme</li>
                <li><b>Light</b>: Always light mode</li>
                <li><b>Dark</b>: Always dark mode</li>
              </ul>
            </PopoverContent>
          </Popover>
          <Dialog open={openDialog} onOpenChange={setOpenDialog}>
            <DialogTrigger asChild>
              <button type="button" className="px-4 py-2 rounded bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold shadow hover:from-blue-600 hover:to-purple-600 transition" onClick={() => setOpenDialog(true)}>
                Delete Account
              </button>
            </DialogTrigger>
            <DialogContent>
